        ...
        while (it.hasNext()) {
            ...
            for (int i = 0; i < fields.length; i++) {
                ...
                try {
                    ...
                    if(i == 0 ) {
                        cash.setId(Integer.valueOf(textValue));
                    } else if(i == 1) {
                        cash.setName(textValue);
                    }else if(i == 2) {
                        cash.setBank(textValue);
                    }else if(i == 3) {
                        cash.setCardNo(textValue);
                    }else if(i == 4) {
                        cash.setPayCash(textValue);
                    }else if(i == 5) {
                        cash.setType(textValue);
                    }else if(i == 6) {
                        cash.setMemo(textValue);
                    }
